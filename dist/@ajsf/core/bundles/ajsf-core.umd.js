(function (global, factory) {
    ...
    (global = global || self, factory((global.ajsf = global.ajsf || {}, global.ajsf.core = {}), global.ng.common, global.ng.forms, global.ng.core, global['lodash-es'], global['lodash-es'], global.rxjs, global.ajv, global.jsonDraft6, global.rxjs.operators, global['lodash-es'], global['lodash-es'], global['lodash-es']));
}(this, (function (exports, common, forms, core, cloneDeep, isEqual$1, rxjs, Ajv, jsonDraft6, operators, filter, map$1, uniqueId) { 'use strict';
    ...
    */
    ...
    function buildFormGroup(template) {
        ...
        if (hasOwn(template, "controlType")) {
            switch (template.controlType) {
                ...
                case "FormArray":
                    return new forms.FormArray(filter(map$1(template.controls, (/**
                     * @param {?} controls
                     * @return {?}
                     */
    ...
    var JsonSchemaFormService = /** @class */ (function () {
        ...
        /** @nocollapse */ JsonSchemaFormService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function JsonSchemaFormService_Factory() { return new JsonSchemaFormService(); }, token: JsonSchemaFormService, providedIn: "root" });
    ...
    var SelectFrameworkComponent = /** @class */ (function () {
        ...
        SelectFrameworkComponent.propDecorators = {
            ...
            layoutIndex: [{ type: core.Input }],
            dataIndex: [{ type: core.Input }],
            widgetContainer: [{ type: core.ViewChild, args: ['widgetContainer', {
    ...
    var WidgetLibraryService = /** @class */ (function () {
        ...
        /** @nocollapse */ WidgetLibraryService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function WidgetLibraryService_Factory() { return new WidgetLibraryService(); }, token: WidgetLibraryService, providedIn: "root" });
    ...
    var FrameworkLibraryService = /** @class */ (function () {
        ...
        /** @nocollapse */ FrameworkLibraryService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function FrameworkLibraryService_Factory() { return new FrameworkLibraryService(core.ɵɵinject(Framework), core.ɵɵinject(WidgetLibraryService)); }, token: FrameworkLibraryService, providedIn: "root" });
